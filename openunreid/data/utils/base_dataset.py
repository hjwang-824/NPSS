...
class Dataset(object):
    ...
    def __init__(
        self, data, mode, transform=None, vis_transform=None, verbose=True, sort=True, **kwargs,
    ):
        self.data = data
        self.transform = transform
        self.vis_transform = vis_transform  # for visualize results
        self.mode = mode
...
class ImageDataset(Dataset):
    ...
    def _get_single_item(self, index):
        ...
        vis_img = read_image(img_path)
        if self.transform is not None:
            img = self.transform(img)

        if self.vis_transform is not None:    # for visualize results
    ...
    def __add__(self, other):
        ...
        vis_transform is for visualize results
        """
        return ImageDataset(
